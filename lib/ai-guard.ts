...
export function buildCompactCandles(candles: { time?: string; open: number; high: number; low: number; close: number }[], maxCount: number): string {
...
export function buildMarketMetrics(candles: { time?: string; open: number; high: number; low: number; close: number }[], maxCount: number, recentCandlesCount: number = 30): string {
